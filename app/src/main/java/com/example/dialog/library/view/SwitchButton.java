...
public class SwitchButton extends AppCompatCheckBox {
     ...
     * 开关未选中状态,即关闭状态时的背景颜色
     */
    private int mBackgroundColorUnchecked = 0x33FFFFFF;
    /**
     * 开关选中状态,即打开状态时的背景颜色
     */
    private int mBackgroundColorChecked = 0xFF6BD45F;
    /**
     * 开关指示器按钮的颜色
     */
     ...
     * 不可点击时的颜色
     */
    private void setUnEnabledColor() {
        this.setChecked(true);
        if (!this.isEnabled()) {
            this.mButtonColor = 0x33FFFFFF;
            this.mBackgroundColorChecked = 0x336BD45F;
            this.mBackgroundColorUnchecked = 0x0DFFFFFF;
        }
    }
