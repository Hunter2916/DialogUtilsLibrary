...
import com.example.dialog.library.listener.FutureListener;
import com.example.dialog.library.listener.PriorityThreadFactory;
...
public class ThreadPool {
    ...
    private static final int KEEP_ALIVE_TIME = 15; // 10 seconds
